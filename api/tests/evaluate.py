...
LLM_EVAL_QUERY_3 = "Was muss ein:e Ausländer:in unternehmen nachdem sie ihre Stelle verloren hat?"
...
llm_evaluator = LLMEvaluator(
    ...
    outputs=["score"],
    examples=[
        {"inputs": {"querries": LLM_EVAL_QUERY_1, "contexts": LLM_EVAL_CONTEXT_1, "responses": LLM_EVAL_RESPONSE_1}, "outputs": {"score": 1}},
        {"inputs": {"querries": LLM_EVAL_QUERY_2, "contexts": LLM_EVAL_CONTEXT_2, "responses": LLM_EVAL_RESPONSE_2}, "outputs": {"score": 1}},
        {"inputs": {"querries": LLM_EVAL_QUERY_3, "contexts": LLM_EVAL_CONTEXT_3, "responses": LLM_EVAL_RESPONSE_3}, "outputs": {"score": 0.7}},
        {"inputs": {"querries": LLM_EVAL_QUERY_4, "contexts": LLM_EVAL_CONTEXT_4, "responses": EXCUSE_RESPONSE}, "outputs": {"score": 0}},
        {"inputs": {"querries": LLM_EVAL_QUERY_5, "contexts": LLM_EVAL_CONTEXT_5, "responses": EXCUSE_RESPONSE}, "outputs": {"score": 1}},
    ],
)
...
results = eval_pipeline.run(
    {
        ...
        "context_relevance_evaluator": {"questions": questions, "contexts": retrieved_docs},
	    "faithfulness_evaluator": {"questions": questions, "contexts": retrieved_docs, "predicted_answers": rag_answers},
        "llm_evaluator": {"querries": questions, "contexts": retrieved_docs, "responses": rag_answers}
...
llm_individual_scores = [result['score'] for result in results['llm_evaluator']['results']]
results['llm_evaluator']['individual_scores'] = llm_individual_scores
results['llm_evaluator']['score'] = sum(llm_individual_scores) / len(llm_individual_scores)

evaluation_result = EvaluationRunResult(run_name="sh_rag_pipeline", inputs=inputs, results=results)
