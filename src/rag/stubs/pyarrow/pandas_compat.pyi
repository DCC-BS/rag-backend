...
def get_logical_type_from_numpy(pandas_collection):  # -> str:
    ...
def get_extension_dtype_info(column):  # -> tuple[str, dict[str, int | Any] | dict[str, Any] | None]:
    ...
def get_column_metadata(
    column, name, arrow_type, field_name
):  # -> dict[str, Any | float | str | dict[str, Any] | dict[str, int | Any] | None]:
...
def construct_metadata(
    columns_to_convert, df, column_names, index_levels, index_descriptors, preserve_index, types, column_field_names=...
):  # -> dict[bytes, bytes]:
...
def dataframe_to_arrays(
    df, schema, preserve_index, nthreads=..., columns=..., safe=...
):  # -> tuple[list[Any], Any, int | None]:
    ...
