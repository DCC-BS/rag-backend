...
def fram_wave(
    waveform: np.array, hop_length: int = ..., fft_window_size: int = ..., center: bool = ...
):  # -> NDArray[Any]:
    """
...
def stft(
    frames: np.array, windowing_function: np.array, fft_window_size: int = ...
):  # -> _Array[tuple[int, int], complexfloating[_32Bit, _32Bit]]:
    """
