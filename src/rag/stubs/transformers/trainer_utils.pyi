...
def find_executable_batch_size(
    function: callable = ..., starting_batch_size: int = ..., auto_find_batch_size: bool = ...
):  # -> partial[Any]:
    """
    Args:
...
class RemoveColumnsCollator:
    ...
    def __init__(
        self, data_collator, signature_columns, logger=..., model_name: str | None = ..., description: str | None = ...
    ) -> None: ...
