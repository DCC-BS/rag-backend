...
class AutomaticSpeechRecognitionPipeline(ChunkPipeline):
    ...
    def __call__(
        self, inputs: np.ndarray | bytes | str, **kwargs
    ...
    def preprocess(
        self, inputs, chunk_length_s=..., stride_length_s=...
    ):  # -> Generator[dict[str | Any, bool | tuple[int, int, int] | Any] | dict[str | Any, bool | Any], Any, None]:
        ...
    def postprocess(
