...
class ZeroShotObjectDetectionPipeline(ChunkPipeline):
    ...
    def __call__(
        self, image: str | Image.Image | list[dict[str, Any]], candidate_labels: str | list[str] = ..., **kwargs
    ):  # -> list[Tensor] | list[Any] | PipelineIterator | Generator[Any, Any, None] | Tensor | Any | None:
        """
