...
def get_parameter_device(parameter: nn.Module | ModuleUtilsMixin):  # -> device:
    ...
def get_first_parameter_dtype(parameter: nn.Module | ModuleUtilsMixin):  # -> dtype:
    """
    Returns the first parameter dtype (can be non-floating) or asserts if none were found.
    """
    ...

def get_parameter_dtype(parameter: nn.Module | ModuleUtilsMixin):  # -> dtype | None:
    """
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin, PeftAdapterMixin):
    ...
    def get_init_context(
        ...
        _is_ds_init_called=...,
        low_cpu_mem_usage=...,
    ):  # -> list[Any | _GeneratorContextManager[None, None, None]] | list[_GeneratorContextManager[None, None, None]]:
        ...
    @classmethod
    ...
    def loss_function(
        self,
    ):  # -> Callable[..., Tensor] | Callable[..., Tensor | None] | Callable[..., Any | Tensor] | Callable[..., tuple[int, Any, list[dict[str, Any]] | None]] | Callable[..., tuple[int, Any, list[dict[str, Any]] | Any]]:
        ...
