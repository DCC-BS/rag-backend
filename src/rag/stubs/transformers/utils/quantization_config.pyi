...
class TorchAoConfig(QuantizationConfigMixin):
    ...
    def __init__(self, quant_type: str | AOBaseConfig, modules_to_not_convert: list | None = ..., **kwargs) -> None: ...
    def post_init(self):  # -> None:
...
class BitNetConfig(QuantizationConfigMixin):
    def __init__(self, modules_to_not_convert: list | None = ..., **kwargs) -> None: ...
    def post_init(self):  # -> None:
        r"""
        Safety checker that arguments are correct
        """
