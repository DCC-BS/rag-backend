...
def to_py_obj(
    obj,
):  # -> dict[Any, dict[Any, Any] | list[dict[Any, Any] | list[Any] | _T_co | list[_T_co] | list[list[_T_co]] | list[list[list[Any]]] | Any | int | float | complex] | _T_co | list[_T_co] | list[list[_T_co]] | list[list[list[Any]]] | Any | int | float | complex] | list[dict[Any, dict[Any, Any] | list[Any] | _T_co | list[_T_co] | list[list[_T_co]] | list[list[list[Any]]] | Any | int | float | complex] | list[Any] | _T_co | list[_T_co] | list[list[_T_co]] | list[list[list[Any]]] | Any | int | float | complex] | _T_co | list[_T_co] | list[list[_T_co]] | list[list[list[Any]]] | int | float | complex:
    """
