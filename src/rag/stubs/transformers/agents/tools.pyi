...
class Tool:
    ...
    def __call__(self, *args, **kwargs):  # -> AgentText | AgentAudio | AgentImage:
        ...
    def setup(self):  # -> None:
        """
    ...
    @classmethod
    def from_hub(cls, repo_id: str, token: str | None = ..., **kwargs):  # -> Any:
        """
    ...
    @staticmethod
    def from_space(
        space_id: str, name: str, description: str, api_name: str | None = ..., token: str | None = ...
    ):  # -> SpaceToolWrapper:
        """
...
class ToolCollection:
    ...
    ```
    """
    def __init__(self, collection_slug: str, token: str | None = ...) -> None: ...
