...
def parse_text_tool_call(text: str) -> tuple[str, str | dict[str, str]]:
    """
...
class Agent:
    def __init__(
        self,
        tools: list[Tool] | Toolbox,
        llm_engine: Callable = ...,
        system_prompt: str | None = ...,
        tool_description_template: str | None = ...,
        additional_args: dict = ...,
        max_iterations: int = ...,
        tool_parser: Callable | None = ...,
        add_base_tools: bool = ...,
        verbose: int = ...,
    ...
    def initialize_for_run(self):  # -> None:
        ...
    def write_inner_memory_from_logs(self, summary_mode: bool | None = ...) -> list[dict[str, str]]:
        """
    ...
    def get_succinct_logs(self):  # -> list[dict[str, str | None]]:
        ...
...
class CodeAgent(Agent):
    ...
    def run(
        self, task: str, return_generated_code: bool = ..., **kwargs
    ):  # -> str | list[Any] | list[Any | tuple[Any, ...] | list[Any]] | Any | tuple[Any, ...] | bool | Series | Callable[..., Any | tuple[Any, ...] | list[Any] | bool | Series | ... | Callable[..., Any] | dict[Any, Any] | str | DataFrame | ndarray[_Shape, Any] | NDArray[Any] | ndarray[_Shape, dtype[Any]] | object | slice[Any, Any, Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | DataFrame | ndarray[_Shape, Any] | NDArray[Any] | ndarray[_Shape, dtype[Any]] | object | slice[Any, Any, Any] | set[Any] | None:
        """
...
class ReactAgent(Agent):
    ...
    def run(
        self, task: str, stream: bool = ..., reset: bool = ..., **kwargs
    ):  # -> Generator[dict[str, int | float] | dict[str, AgentMaxIterationsError] | str | int | float | None, Any, None] | str | int | float | None:
        """
        Runs the agent for the given task.
    ...
    def stream_run(
        self, task: str
    ):  # -> Generator[dict[str, int | float] | dict[str, AgentMaxIterationsError] | str | int | float | None, Any, None]:
        """
        Runs the agent in streaming mode, yielding steps as they are executed: should be launched only in the `run` method.
        """
        ...

    def direct_run(self, task: str):  # -> str | int | float | None:
        """
...
class ReactCodeAgent(ReactAgent):
    ...
    ):  # -> list[Any] | list[Any | tuple[Any, ...] | list[Any]] | Any | tuple[Any, ...] | bool | Series | Callable[..., Any | tuple[Any, ...] | list[Any] | bool | Series | ... | Callable[..., Any] | dict[Any, Any] | str | DataFrame | ndarray[_Shape, Any] | NDArray[Any] | ndarray[_Shape, dtype[Any]] | object | slice[Any, Any, Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | str | DataFrame | ndarray[_Shape, Any] | NDArray[Any] | ndarray[_Shape, dtype[Any]] | object | slice[Any, Any, Any] | set[Any] | None:
        """
        Perform one step in the ReAct framework: the agent thinks, acts, and observes the result.
        The errors are raised here, they are caught and logged in the run() method.
        """
