...
class Cache:
    ...
    def get_usable_length(self, new_seq_length: int, layer_idx: int | None = ...) -> int:
...
class EncoderDecoderCache(Cache):
    ...
    @classmethod
    def from_legacy_cache(cls, past_key_values: tuple[tuple[torch.FloatTensor]] | None = ...) -> EncoderDecoderCache:
...
class HybridCache(Cache):
    ...
    def get_max_cache_shape(self) -> int | None: ...
    def get_seq_length(self, layer_idx: int | None = ...):  # -> Tensor:
        ...
    def reset(self):  # -> None:
        """Resets the cache values while preserving the objects"""
        ...
