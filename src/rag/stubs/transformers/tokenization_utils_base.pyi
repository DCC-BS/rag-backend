...
class BatchEncoding(UserDict):
    ...
    def token_to_chars(self, batch_or_token_index: int, token_index: int | None = ...) -> CharSpan:
        """
...
class SpecialTokensMixin:
    ...
    def add_special_tokens(
        self, special_tokens_dict: dict[str, str | AddedToken], replace_additional_special_tokens=...
    ) -> int:
        """
    ...
    def add_tokens(self, new_tokens: str | AddedToken | list[str | AddedToken], special_tokens: bool = ...) -> int:
        """
