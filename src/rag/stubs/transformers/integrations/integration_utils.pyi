...
def get_reporting_integration_callbacks(
    report_to,
):  # -> list[Any] | list[type[AzureMLCallback] | type[CometCallback] | type[MLflowCallback] | type[NeptuneCallback] | type[TensorBoardCallback] | type[WandbCallback] | type[CodeCarbonCallback] | type[ClearMLCallback] | type[DagsHubCallback] | type[FlyteCallback] | type[DVCLiveCallback] | type[SwanLabCallback]]:
    ...
