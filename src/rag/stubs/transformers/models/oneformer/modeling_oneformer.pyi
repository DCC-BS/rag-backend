...
def multi_scale_deformable_attention(
    value: Tensor, value_spatial_shapes: Tensor | list[tuple], sampling_locations: Tensor, attention_weights: Tensor
) -> Tensor: ...
...
class OneFormerTextTransformer(nn.Module):
    def __init__(
        self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = ..., use_checkpoint=..., layer_norm_eps=...
    ) -> None: ...
...
@add_start_docstrings(
    "The bare OneFormer Model outputting raw hidden-states without any specific head on top.", ONEFORMER_START_DOCSTRING
)
...
@add_start_docstrings(
    "OneFormer Model for instance, semantic and panoptic image segmentation.", ONEFORMER_START_DOCSTRING
)
