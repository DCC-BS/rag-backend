...
class PvtFFN(nn.Module):
    def __init__(
        self, config: PvtConfig, in_features: int, hidden_features: int | None = ..., out_features: int | None = ...
    ) -> None: ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor: ...
...
@add_start_docstrings(
    "The bare Pvt encoder outputting raw hidden-states without any specific head on top.", PVT_START_DOCSTRING
)
