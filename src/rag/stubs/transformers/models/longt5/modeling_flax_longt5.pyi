...
class FlaxLongT5LocalAttention(nn.Module):
    ...
    def __call__(
        ...
        output_attentions=...,
        deterministic=...,
    ):  # -> tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]]:
        """
        Self-attention (if key_value_states is None) or attention over source sentence (provided by key_value_states).
        """
        ...
...
class FlaxLongT5Block(nn.Module):
    ...
    def __call__(
        ...
        deterministic=...,
        init_cache=...,
    ):  # -> tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any | ndarray[Any, Any], ...]] | tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any, ...]] | tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any], Any] | tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any]] | tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any, Any] | tuple[Any | tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any]:
        ...
