...
class FalconMambaModel(FalconMambaPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC, output_type=FalconMambaOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
...
class FalconMambaForCausalLM(FalconMambaPreTrainedModel, GenerationMixin):
    ...
    @add_start_docstrings_to_model_forward(FALCONMAMBA_INPUTS_DOCSTRING)
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC, output_type=FalconMambaCausalLMOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.LongTensor | None = ...,
