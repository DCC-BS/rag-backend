...
@add_start_docstrings(
    "The bare Idefics3 Model outputting raw hidden-states without any specific head on top.", IDEFICS3_START_DOCSTRING
)
...
@add_start_docstrings(
    "The Idefics3 Vision Transformer Model outputting raw image embedding.", IDEFICS3_VISION_START_DOCSTRING
)
...
@add_start_docstrings(
    """Idefics3 model consisting of a SIGLIP vision encoder and Llama3 language decoder""", IDEFICS3_START_DOCSTRING
)
class Idefics3Model(Idefics3PreTrainedModel):
    ...
    def set_input_embeddings(self, value):  # -> None:
        ...
    def inputs_merger(
        self, input_ids: torch.LongTensor, inputs_embeds: torch.Tensor | None, image_hidden_states: torch.Tensor | None
    ):  # -> Tensor:
        """
