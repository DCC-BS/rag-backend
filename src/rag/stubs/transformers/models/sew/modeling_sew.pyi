...
class SEWEncoder(nn.Module):
    ...
    ):  # -> tuple[Tensor | Any | tuple[Any, ...] | tuple[()] | tuple[Any | None, ...], ...] | BaseModelOutput:
        ...
...
@add_start_docstrings(
    "The bare SEW Model transformer outputting raw hidden-states without any specific head on top.", SEW_START_DOCSTRING
)
