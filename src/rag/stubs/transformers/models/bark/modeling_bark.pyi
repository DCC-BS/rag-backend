...
class BarkSelfFlashAttention2(BarkSelfAttention):
    ...
    def forward(
        ...
        use_cache=...,
        output_attentions=...,
    ):  # -> tuple[Any, tuple[Tensor | Any, Tensor | Any] | None, None] | tuple[Any, tuple[Tensor | Any, Tensor | Any] | None]:
        ...
...
class BarkCausalModel(BarkPreTrainedModel, GenerationMixin):
    ...
    def set_input_embeddings(self, new_embeddings):  # -> None:
        ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=..., **kwargs):  # -> dict[str, Any | None]:
        ...
...
class BarkModel(BarkPreTrainedModel):
    ...
    def enable_cpu_offload(self, gpu_id: int | None = ...):  # -> None:
        r"""
