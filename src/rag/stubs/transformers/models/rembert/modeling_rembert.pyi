...
class RemBertModel(RemBertPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint="google/rembert", output_type=BaseModelOutputWithPastAndCrossAttentions, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
...
class RemBertForSequenceClassification(RemBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(REMBERT_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
        checkpoint="google/rembert", output_type=SequenceClassifierOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
...
class RemBertForMultipleChoice(RemBertPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint="google/rembert", output_type=MultipleChoiceModelOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.FloatTensor = ...,
...
class RemBertForTokenClassification(RemBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(REMBERT_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
        checkpoint="google/rembert", output_type=TokenClassifierOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.FloatTensor = ...,
...
class RemBertForQuestionAnswering(RemBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(REMBERT_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
        checkpoint="google/rembert", output_type=QuestionAnsweringModelOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.FloatTensor = ...,
