...
def get_image_size_for_max_height_width(
    input_image: np.ndarray, max_height: int, max_width: int, input_data_format: str | ChannelDimension | None = ...
) -> tuple[int, int]:
    """
...
class DetaImageProcessor(BaseImageProcessor):
    ...
    def post_process_object_detection(
        self, outputs, threshold: float = ..., target_sizes: TensorType | list[tuple] = ..., nms_threshold: float = ...
    ):  # -> list[Any]:
        """
