...
@add_start_docstrings(
    "The bare Informer Model outputting raw hidden-states without any specific head on top.", INFORMER_START_DOCSTRING
)
...
@add_start_docstrings(
    "The Informer Model with a distribution head on top for time-series forecasting.", INFORMER_START_DOCSTRING
)
