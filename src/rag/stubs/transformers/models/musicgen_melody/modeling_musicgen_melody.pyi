...
@add_start_docstrings(
    "The Musicgen Melody decoder model with a language modelling head on top.", MUSICGEN_MELODY_START_DOCSTRING
)
class MusicgenMelodyForCausalLM(MusicgenMelodyPreTrainedModel, GenerationMixin):
    ...
    def build_delay_pattern_mask(
        self, input_ids: torch.LongTensor, pad_token_id: int, max_length: int = ...
...
class MusicgenMelodyForConditionalGeneration(PreTrainedModel, GenerationMixin):
    ...
    def from_sub_models_pretrained(
        cls,
        text_encoder_pretrained_model_name_or_path: str = ...,
        audio_encoder_pretrained_model_name_or_path: str = ...,
