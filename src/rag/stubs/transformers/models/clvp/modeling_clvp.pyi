...
@add_start_docstrings(
    "The bare Clvp decoder model outputting raw hidden-states without any specific head on top.", CLVP_START_DOCSTRING
)
...
class ClvpForCausalLM(ClvpPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        self, input_ids, past_key_values=..., inputs_embeds=..., conditioning_embeds=..., **kwargs
    ):  # -> dict[str, Any]:
        ...
    @add_start_docstrings_to_model_forward(CLVP_DECODER_INPUTS_DOCSTRING)
    def forward(
