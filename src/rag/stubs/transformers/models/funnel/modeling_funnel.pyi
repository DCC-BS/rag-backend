...
class FunnelAttentionStructure(nn.Module):
    ...
    def stride_pool(
        self, tensor: torch.Tensor | tuple[torch.Tensor] | list[torch.Tensor], axis: int | tuple[int] | list[int]
    ) -> torch.Tensor:
        """
...
class FunnelBaseModel(FunnelPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint="funnel-transformer/small-base", output_type=BaseModelOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
...
class FunnelForMaskedLM(FunnelPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(FUNNEL_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC, output_type=MaskedLMOutput, config_class=_CONFIG_FOR_DOC, mask="<mask>"
    )
    def forward(
        self,
        input_ids: torch.Tensor | None = ...,
...
class FunnelForSequenceClassification(FunnelPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(FUNNEL_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
        checkpoint="funnel-transformer/small-base", output_type=SequenceClassifierOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.Tensor | None = ...,
...
class FunnelForMultipleChoice(FunnelPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint="funnel-transformer/small-base", output_type=MultipleChoiceModelOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.Tensor | None = ...,
