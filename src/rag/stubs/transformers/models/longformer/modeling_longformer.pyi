...
class LongformerForTokenClassification(LongformerPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        ...
        config_class=_CONFIG_FOR_DOC,
        expected_output="['Evidence', 'Evidence', 'Evidence', 'Evidence', 'Evidence', 'Evidence', 'Evidence', 'Evidence',"
...
class LongformerForMultipleChoice(LongformerPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC, output_type=LongformerMultipleChoiceModelOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: torch.Tensor | None = ...,
