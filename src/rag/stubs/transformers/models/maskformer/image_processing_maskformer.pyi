...
):  # -> tuple[ndarray[_Shape, dtype[floating[_32Bit]]] | ndarray[tuple[int], dtype[floating[_32Bit]]], ndarray[tuple[int], dtype[signedinteger[_64Bit]]] | ndarray[_Shape, dtype[signedinteger[_64Bit]]]]:
    ...
...
class MaskFormerImageProcessor(BaseImageProcessor):
    ...
    def post_process_segmentation(
        self, outputs: MaskFormerForInstanceSegmentationOutput, target_size: tuple[int, int] = ...
    ) -> torch.Tensor:
        """
