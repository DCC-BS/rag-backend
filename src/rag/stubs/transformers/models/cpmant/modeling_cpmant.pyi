...
class CpmAntAttention(nn.Module):
    ...
    def forward(
        ...
        use_cache: bool | None = ...,
    ):  # -> tuple[Any, Tensor | None, Tuple[Tensor, Tensor] | None]:
        """
        Args:
            hidden_q (`torch.Tensor`):
...
class CpmAntEncoder(nn.Module):
    ...
    def forward(
        ...
        past_key_values: tuple[torch.Tensor, torch.Tensor] | None = ...,
        use_cache: bool | None = ...,
    ):  # -> tuple[Tensor, tuple[()] | tuple[Any, ...] | None, tuple[Tensor, ...] | Any | tuple[()] | None, tuple[()] | tuple[Any, ...] | None]:
        """
        Args:
            hidden_states (`torch.Tensor`):
                Input to the layer of shape `(batch, seq_len, dim_model)`
...
@add_start_docstrings(
    "The bare CPMAnt Model outputting raw hidden-states without any specific head on top.", CPMANT_START_DOCSTRING
)
class CpmAntModel(CpmAntPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC, output_type=BaseModelOutputWithPast, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
