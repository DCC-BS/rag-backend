...
class TFBlenderbotModel(TFBlenderbotPreTrainedModel):
    ...
    ):  # -> tuple[Any, dict[str, list[Any] | Any]] | tuple[TFBlenderbotSmallModel, dict[str, set[Any] | list[str | Any] | list[Any]]] | TFBlenderbotSmallModel | tuple[Self, dict[str, set[Any] | list[str | Any] | list[Any]]] | Self:
        ...
    @unpack_inputs
...
class TFBlenderbotForConditionalGeneration(TFBlenderbotPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(
        cls, pretrained_model_name_or_path: str | os.PathLike | None, *model_args, **kwargs
    ):  # -> tuple[Any, dict[str, list[Any] | Any]] | tuple[TFBlenderbotSmallForConditionalGeneration, dict[str, set[Any] | list[str | Any] | list[Any]]] | TFBlenderbotSmallForConditionalGeneration | tuple[Self, dict[str, set[Any] | list[str | Any] | list[Any]]] | Self:
        ...
    @unpack_inputs
